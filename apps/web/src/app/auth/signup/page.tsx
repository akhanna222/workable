    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-900 rounded-xl border border-gray-800">
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-2">Start building amazing apps with AI</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            type="button"
            className="flex items-center justify-center gap-2 py-2 px-4 bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-lg text-white transition-colors"
          >
